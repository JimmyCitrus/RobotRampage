...
public class Game : MonoBehaviour {
    ...
    // Frees the mouse cursor when the game ends
    public void OnGUI()
    {
    ...
    // Disables the controls and robots
    ...
    // Reloads the scene to start again when button is pressed
    ...
    // Quits the app when run from a build
    public void Exit()
    {
        Application.Quit();
    }
